    ...
    setup(
        ...
        ext_modules=[
            ...
            make_cuda_ext(
                name='oks_nms_cpu',
                module='mmdet.ops.nms',
                sources=['src/oks_nms_cpu.cpp']),
            make_cuda_ext(
                name='oks_nms_vis_cuda',
                module='mmdet.ops.nms',
                sources=['src/oks_nms_vis_cuda.cpp', 'src/oks_nms_vis_kernel.cu']),
            make_cuda_ext(
                name='oks_nms_cuda',
                module='mmdet.ops.nms',
                sources=['src/oks_nms_cuda.cpp', 'src/oks_nms_kernel.cu']),
            make_cuda_ext(
                name='roi_align_cuda',
